...
export const HOW_TO_SET_EXPLAINER = {
  ...
  paragraphs: [
    "Nostr identity is a secure keypair. Your profile is owned by the key, not by Good Earth.",
    "To change it, use your preferred Nostr client — the one that already holds your key.",
    "Good Earth could accept your nsec directly, but deliberately does not ask for it. Handing a private key to a web frontend is the thing the keypair model exists to avoid.",
  ],
} as const;
